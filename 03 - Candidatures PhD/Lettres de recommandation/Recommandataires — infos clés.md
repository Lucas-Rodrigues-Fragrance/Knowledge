---
type: candidature
tags: [candidature, PhD, lettres-recommandation]
date: 2026-06-22
statut: brouillon à compléter par Lucas
---

# ✉️ Recommandataires — informations clés

> Document de travail pour préparer les **dossiers à remettre à mes
> recommandataires** : Michel Puech, Pierre-Henri Castel, Emanuele Coccia.
> Objectif : leur **faciliter la rédaction** et **orienter** ce que chacun met en avant.
...
## 📦 À remettre à CHAQUE recommandataire (pack standard)
- [ ] **CV académique** à jour.
- [ ] **Résumé de projet de recherche** (½ page — extrait de [[Projet de recherche (brouillon)]]).
- [ ] **Liste des programmes** + **deadlines** + **mode d'envoi** (portail vs e-mail) + **date limite pour eux** (idéalement 3-4 semaines avant).
- [ ] **Rappel personnalisé** : le cours suivi avec eux + le travail rendu + 2-3 points à souligner (les sections ci-dessus).
- [ ] Mon **échantillon d'écriture** (writing sample) si pertinent.
- [ ] **Relevés de notes** si demandés.

## 🗓️ Logistique des lettres (à savoir)
- La plupart des universités US/UK envoient un **e-mail automatique** au recommandataire avec un lien d'upload, une fois que vous avez saisi ses coordonnées dans le portail.
- Prévenez-les **bien à l'avance** (idéal : été/début automne 2026 pour des deadlines de déc. 2026).
- Donnez-leur **une seule liste claire** de toutes les universités + dates, pour qu'ils n'aient qu'à téléverser.

## ✅ Ce que j'ai besoin de compléter (Lucas)
1. Pour **Puech** : intitulé exact du cours + travail rendu + note.
2. Pour **Castel** : confirmer que « Santé mentale » est bien son séminaire (et le co-enseignant « Alain ») + travail rendu.
3. Pour **Coccia** : quel séminaire/travail/échange concret ?
4. Veux-tu que je rédige, pour chacun, un **e-mail de demande de lettre** + un **mémo d'une page** prêt à remettre ?

*Fiche créée le 2026-06-22. Profils vérifiés via sources publiques ; les éléments « de première main » sont à compléter par Lucas.*
